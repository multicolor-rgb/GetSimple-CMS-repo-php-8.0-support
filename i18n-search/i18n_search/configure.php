<?php
  ...
  if (isset($_POST['reset'])) {
    ...
    foreach (['showTags', 'showLanguage', 'showDate', 'showPaging', 'mark'] as $name) {
  ...
  <form method="post" id="searchForm" action="<?php echo $link; ?>" style="clear:both">
    <table id="editsearch" class="edittable highlight">
      <tbody>
        ...
        <tr><td><?php i18n('i18n_search/TRANSLITERATION'); ?></td><td><textarea name="transliteration" 
        style="width:5em; height:100px;" class="text"><?php echo htmlspecialchars(@$params['transliteration']?? ''); ?></textarea></td><td></td></tr>
      </tbody>
    </table>
