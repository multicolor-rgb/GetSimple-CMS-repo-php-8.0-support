  ...
  <div class="wrapper">
    <div id="maincontent">
  	  <div class="main" style="border:none;">
			  ...
			  <div class="edit-nav" >
          <p>
            <?php echo i18n_r('i18n_customfields/FILTER'); ?>: <input type="text" id="filter" value="" class="text" style="width:80px"/>
            <a href="<?php echo $link; ?>&view=hierarchical" <?php echo $view=='hierarchical' ? 'class="current"' : ''; ?> ><?php echo i18n_r('i18n_customfields/VIEW_HIERARCHICAL'); ?></a>
            <a href="<?php echo $link; ?>&view=title" <?php echo $view=='title' ? 'class="current"' : ''; ?> ><?php echo i18n_r('i18n_customfields/VIEW_TITLE'); ?></a>
          </p>
          <div class="clear" ></div>
        </div>
