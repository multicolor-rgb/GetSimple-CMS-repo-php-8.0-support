...
document.querySelectorAll('.enabled').forEach(x=>{x.style.display="flex"});
document.querySelectorAll('.disabled').forEach(z=>{z.style.display="flex"});
...
document.querySelector('.plugin-on').addEventListener('click',()=>{
    ...
    document.querySelectorAll('.enabled').forEach(x=>{x.style.display="flex"});
document.querySelectorAll('.disabled').forEach(z=>{z.style.display="none"});
...
document.querySelectorAll('.disabled').forEach(x=>{x.style.display="flex"});
document.querySelectorAll('.enabled').forEach(z=>{z.style.display="none"});
